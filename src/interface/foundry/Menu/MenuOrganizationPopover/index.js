...
const Body = props => <Box w={[1,1,675]} bs={4} br={10} >
  <Flex direction={['column', 'row']} >
    <Box w={[1,1,0.45]} bg='sand' p={[10,15]} bs={1} >
      ...
      {DialogOpen ? <DialogOpen foundry='OrganizationAddFull'><PopoverClose delta='MenuOrganization' ><Button gradient='cherry' w={1} >Add Organization</Button></PopoverClose></DialogOpen> : null }
...
export default props => <Flex diretion={['column', 'row']} >
  <Box px={[10]}>
    <PopoverPure delta='MenuOrganization' body={Body} >
      <Heading level={[3]} f={[3]}>Organizations</Heading>
    </PopoverPure>
    </Box>
</Flex>