...
const Body = props => <Box w={[1,1,675]} bs={4} br={10} >
  <Flex direction={['column', 'row']} >
    <Box w={[1,1,0.45]} bg='sand' p={[10,15]} bs={1} >
      ...
      <Paragraph f={[1]}>
        Easily find Resources in the Marin County Community. Search by type, services, availability, etc...
      </Paragraph>
      {DialogOpen ? <DialogOpen foundry='ResourceAddFull'><PopoverClose delta='MenuResource' ><Button gradient='cherry' w={1} >Add Resource</Button></PopoverClose></DialogOpen> : null }
...
export default props => <Flex diretion={['column', 'row']} >
  <Box px={[10]}>
    <PopoverPure delta='MenuResource' body={Body} >
      <Heading level={[3]} f={[3]} >Resources</Heading>
    </PopoverPure>
    </Box>
</Flex>