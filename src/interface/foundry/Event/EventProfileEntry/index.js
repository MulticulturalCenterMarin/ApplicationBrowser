  ...
  return <div>
    <Absolute top bottom left bg='white' pos={['relative !important', 'relative !important', 'absolute !important']} h={[1]} of='hidden' w={[1,1, 0.77]}>
        ...
        <Box p={[20,35]}>
          ...
          {/*--- Edit::Event ---*/}
          {!props.data ? null : 
          <Route exact path="/dashboard/event/:eid/edit" component={MarkdownEditor} collection='event' delta={props.id}  markdownDefault={idx(props.data, _ => _.content.contentBody)}/>}
