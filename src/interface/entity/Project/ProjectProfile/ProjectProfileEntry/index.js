  ...
  return <div>
    <Absolute top bottom left bg='white' pos={['relative !important', 'relative !important', 'absolute !important']} h={[1]} of='hidden' w={[1,1, 0.77]}>
        ...
        <Box p={[20,35]}>
          ...
          {/*--- Activity::Project ---*/}
          <Route exact path="/dashboard/:entity/:eid/activity"
          component={ProjectStatusUpdates} {...props} 
          />
          
          {/*--- Edit::Project ---*/}
          {!props.data ? null : 
          <Route path="/dashboard/:entity/:eid/edit" 
    ...
    <Absolute top right gradient='gray' pos={['relative !important', 'relative !important', 'absolute !important']} bs={[3]} h={[1]} w={[1,1, 0.23]} z={15}>
      <PerfectScrollbar>
        ...
        <Box p={[10]} >
          ...
          collection="projects" delta="ProjectPeopleSearch"
          /> }
        </Box>
      </PerfectScrollbar>
    </Absolute>
