...
export default props => <Box w={[1,1, 240]} p={[10,15]} >
  ...
  <Paragraph f={[1]}>Persons are managed by the community. Everyone can start and participate in public resources. Additionally, resources can be kept private with small, focused teams. You decide what's right.</Paragraph>
