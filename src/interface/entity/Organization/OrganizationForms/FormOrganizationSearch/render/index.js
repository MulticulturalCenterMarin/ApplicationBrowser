...
<Block {...styled}>
  <Box>
    <Field name="searchOrganizationName" placeholder="Organization Name" component={ReduxField} type="text" />
    <Field name="searchOrganizationAlias" placeholder="Alias(Codename)" component={ReduxField} type="text" mt={[10]} />
  </Box>
  <Box mt={10} >
