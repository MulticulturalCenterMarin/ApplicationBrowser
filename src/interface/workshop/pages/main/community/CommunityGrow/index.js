...
<Section bg={['orange']}
  ...
  <BackgroundImage image={assets.images.facepaint} z={[0]} opacity={[0.75]} bs={['insetBottomHeavy']} />
...
<Section color={['charcoal']} z={15} pos='relative' >
  ...
  >
    <BackgroundGradient gradient='ibize' />
    <BackgroundImage image={assets.images.canal} o={[0.5]} br={10} b={'2px solid #FFF'} bs={[0,1]} />
      <Container w={[0.6]} >
