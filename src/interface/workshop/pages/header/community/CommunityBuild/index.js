...
const Front = ({ ...props }) => {
  return (
    <Section {...props} 
        ...
        pos='relative'
      >
      <BackgroundImage image={assets.images.spacex} o={[0.5]} />
      <Container>
        <Flex direction={['column', 'column', 'row']} align='center'  mh={['50vh', '50vh', '70vh']}>
          ...
          <Box w={[1,1,0.5]}>
            ...
            <Paragraph fontSize={[2]} fontWeight={[100]} mb={[10]} ts={['darkPurple']}>
              To grow as a community we must first start with the roots. Preparing the soil, clearing the brush and organizing the seeds. 
            </Paragraph>
            <Paragraph fontSize={[2]} fontWeight={[100]} mb={[10]} ts={['darkPurple']}>
